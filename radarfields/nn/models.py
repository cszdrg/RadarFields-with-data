...
class RadarField(nn.Module):
    ...
    def gumbel_sigmoid(self, logits, tau=1.0, hard=False, eps=1e-8):
    ...
    def forward(self, xyz, angle, gumbel_tau, sin_epoch=None):  
        out = {}
        ...
        elif self.alpha_activation == "gumbel_sigmoid":
            alpha = self.gumbel_sigmoid(
                alpha,
                tau=gumbel_tau,
