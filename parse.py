...
def get_arg_parser():
    ...
    parser.add_argument("--occ_loss", type=str, default="BCELoss", choices=["kl", "mse", "BCELoss"])
    ...
    # new
    parser.add_argument("--ground_filter", action="store_true", help="ground_filter")
    parser.add_argument("--importance_sampling", action="store_true", help="importance_sampling")
